...
class ChatlogsParserConfigWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        mode_layout.setSpacing(spacing)
        ...
        username_layout.setSpacing(spacing)
        ...
        search_layout.setSpacing(spacing)
        ...
        mention_layout.setSpacing(spacing)
    ...
    def _on_mode_changed(self, index: int):
        ...
        if mode == "Single Date":
            ...
            sub_mode_layout.setSpacing(spacing)
